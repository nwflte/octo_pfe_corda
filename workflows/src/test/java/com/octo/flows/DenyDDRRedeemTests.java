...
public class DenyDDRRedeemTests {
    ...
    public DenyDDRRedeemTests() {
        a.registerInitiatedFlow(DenyDDRRedeem.Responder.class);
    ...
    public void flowRecordsATransactionInBothPartiesTransactionStorages() throws Exception {
        DenyDDRRedeem.Initiator flow = new DenyDDRRedeem.Initiator(externalId);
