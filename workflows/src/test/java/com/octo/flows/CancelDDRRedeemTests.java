...
public class CancelDDRRedeemTests {
    ...
    public CancelDDRRedeemTests() {
        bc.registerInitiatedFlow(CancelDDRRedeem.Responder.class);
    ...
    public void flowRecordsATransactionInBothPartiesTransactionStorages() throws Exception {
        CancelDDRRedeem.Initiator flow = new CancelDDRRedeem.Initiator(externalId);
        CordaFuture<SignedTransaction> future = a.startFlow(flow);
        network.runNetwork();
    ...
    public void recordedTransactionHasSingleInputAndNoOutput() throws Exception {
        ...
        for (StartedMockNode node : ImmutableList.of(a, bc)) {
            ...
            assertEquals(DDRObligationType.REDEEM, consumedState.getType());
