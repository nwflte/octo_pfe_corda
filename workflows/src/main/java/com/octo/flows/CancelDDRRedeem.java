...
public class CancelDDRRedeem {
    ...
    public static class Initiator extends FlowLogic<SignedTransaction> {
        ...
        public SignedTransaction call() throws FlowException {
            ...
            final TransactionBuilder txBuilder = cancelRedeemTx(requestStateAndRef);
        ...
        private TransactionBuilder cancelRedeemTx(StateAndRef<DDRObligationState> inputStateAndRef) {
            ...
            return new TransactionBuilder(inputStateAndRef.getState().getNotary())
                    ...
                    .addOutputState(new DDRObligationStateBuilder(inputState).status(DDRObligationStatus.CANCELED).build())
